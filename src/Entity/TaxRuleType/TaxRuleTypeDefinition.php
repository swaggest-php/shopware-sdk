...
final class TaxRuleTypeDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('rules', Association::ONE_TO_MANY, 'tax_rule', 'id', 'taxRuleTypeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete()),
            (new Association('translations', Association::ONE_TO_MANY, 'tax_rule_type_translation', 'id', 'taxRuleTypeId', 'taxRuleTypeId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
