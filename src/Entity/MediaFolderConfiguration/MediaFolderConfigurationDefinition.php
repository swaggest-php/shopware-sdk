...
final class MediaFolderConfigurationDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('mediaFolders', Association::ONE_TO_MANY, 'media_folder', 'id', 'configurationId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('mediaThumbnailSizes', Association::MANY_TO_MANY, 'media_thumbnail_size', 'id', 'id', null, 'media_folder_configuration_media_thumbnail_size', 'mediaThumbnailSizeId', 'mediaFolderConfigurationId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
