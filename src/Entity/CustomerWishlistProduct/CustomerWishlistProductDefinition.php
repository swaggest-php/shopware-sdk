...
final class CustomerWishlistProductDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('wishlist', Association::MANY_TO_ONE, 'customer_wishlist', 'wishlistId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
