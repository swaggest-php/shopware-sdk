...
final class AppActionButtonTranslationDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('appActionButton', Association::MANY_TO_ONE, 'app_action_button', 'appActionButtonId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
