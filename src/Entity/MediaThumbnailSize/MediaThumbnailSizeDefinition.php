...
final class MediaThumbnailSizeDefinition extends AbstractEntityDefinition
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new AssociationField('mediaFolderConfigurations', AssociationField::MANY_TO_MANY, 'media_folder_configuration', 'id', 'id', null, 'media_folder_configuration_media_thumbnail_size', 'mediaFolderConfigurationId', 'mediaThumbnailSizeId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
