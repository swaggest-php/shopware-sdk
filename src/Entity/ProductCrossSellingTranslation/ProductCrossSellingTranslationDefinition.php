...
final class ProductCrossSellingTranslationDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('productCrossSelling', Association::MANY_TO_ONE, 'product_cross_selling', 'productCrossSellingId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
