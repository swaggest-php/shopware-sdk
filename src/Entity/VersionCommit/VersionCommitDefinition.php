...
final class VersionCommitDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('data', Association::ONE_TO_MANY, 'version_commit_data', 'id', 'versionCommitId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
            (new Association('version', Association::MANY_TO_ONE, 'version', 'versionId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
