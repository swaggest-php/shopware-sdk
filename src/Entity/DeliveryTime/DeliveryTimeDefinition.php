...
final class DeliveryTimeDefinition extends AbstractEntityDefinition
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new AssociationField('shippingMethods', AssociationField::ONE_TO_MANY, 'shipping_method', 'id', 'deliveryTimeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new AssociationField('products', AssociationField::ONE_TO_MANY, 'product', 'id', 'deliveryTimeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new AssociationField('translations', AssociationField::ONE_TO_MANY, 'delivery_time_translation', 'id', 'deliveryTimeId', 'deliveryTimeId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
