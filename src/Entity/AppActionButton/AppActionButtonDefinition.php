...
final class AppActionButtonDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('translations', Association::ONE_TO_MANY, 'app_action_button_translation', 'id', 'appActionButtonId', 'appActionButtonId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
