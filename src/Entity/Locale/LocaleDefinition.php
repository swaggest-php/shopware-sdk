...
final class LocaleDefinition extends AbstractEntityDefinition
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new AssociationField('languages', AssociationField::ONE_TO_MANY, 'language', 'id', 'localeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
            (new AssociationField('translations', AssociationField::ONE_TO_MANY, 'locale_translation', 'id', 'localeId', 'localeId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
            (new AssociationField('users', AssociationField::ONE_TO_MANY, 'user', 'id', 'localeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete()),
