...
final class ProductCrossSellingAssignedProductsDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('crossSelling', Association::MANY_TO_ONE, 'product_cross_selling', 'crossSellingId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
