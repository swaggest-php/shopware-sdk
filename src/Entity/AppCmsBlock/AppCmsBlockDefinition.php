...
final class AppCmsBlockDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('translations', Association::ONE_TO_MANY, 'app_cms_block_translation', 'id', 'appCmsBlockId', 'appCmsBlockId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
