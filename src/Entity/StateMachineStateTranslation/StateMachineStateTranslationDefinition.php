...
final class StateMachineStateTranslationDefinition extends AbstractEntityDefinition
{
    ...
    protected function defineFields(): array
    {
        return [
            ...
            (new AssociationField('stateMachineState', AssociationField::MANY_TO_ONE, 'state_machine_state', 'stateMachineStateId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
