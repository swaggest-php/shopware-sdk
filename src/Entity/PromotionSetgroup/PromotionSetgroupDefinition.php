...
final class PromotionSetgroupDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('setGroupRules', Association::MANY_TO_MANY, 'rule', 'id', 'id', null, 'promotion_setgroup_rule', 'ruleId', 'setgroupId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
