...
final class SalesChannelDomainDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('snippetSet', Association::MANY_TO_ONE, 'snippet_set', 'snippetSetId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('salesChannelDefaultHreflang', Association::ONE_TO_ONE, 'sales_channel', 'id', 'hreflangDefaultDomainId', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API])),
            (new Association('productExports', Association::ONE_TO_MANY, 'product_export', 'id', 'salesChannelDomainId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
