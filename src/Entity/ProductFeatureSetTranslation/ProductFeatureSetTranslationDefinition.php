...
final class ProductFeatureSetTranslationDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('productFeatureSet', Association::MANY_TO_ONE, 'product_feature_set', 'productFeatureSetId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
