...
final class EventActionDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('rules', Association::MANY_TO_MANY, 'rule', 'id', 'id', null, 'event_action_rule', 'ruleId', 'eventActionId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new SearchRanking(0.250000)),
            (new Association('salesChannels', Association::MANY_TO_MANY, 'sales_channel', 'id', 'id', null, 'event_action_sales_channel', 'salesChannelId', 'eventActionId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new SearchRanking(0.250000)),
