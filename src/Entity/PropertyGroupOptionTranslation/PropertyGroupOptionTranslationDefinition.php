...
final class PropertyGroupOptionTranslationDefinition extends AbstractEntityDefinition
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Field('propertyGroupOptionId', 'uuid'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API]), new PrimaryKey(), new Required()),
            ...
            (new AssociationField('propertyGroupOption', AssociationField::MANY_TO_ONE, 'property_group_option', 'propertyGroupOptionId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
