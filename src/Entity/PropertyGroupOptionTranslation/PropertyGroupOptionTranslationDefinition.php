...
final class PropertyGroupOptionTranslationDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('propertyGroupOption', Association::MANY_TO_ONE, 'property_group_option', 'propertyGroupOptionId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
