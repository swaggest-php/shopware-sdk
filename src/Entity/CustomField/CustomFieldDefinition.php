...
final class CustomFieldDefinition extends AbstractEntityDefinition
{
    ...
    protected function defineFields(): array
    {
        return [
            ...
            (new AssociationField('productSearchConfigFields', AssociationField::ONE_TO_MANY, 'product_search_config_field', 'id', 'customFieldId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
