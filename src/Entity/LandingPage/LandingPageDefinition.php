...
final class LandingPageDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('translations', Association::ONE_TO_MANY, 'landing_page_translation', 'id', 'landingPageId', 'landingPageId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API]), new CascadeDelete(), new Required()),
            (new Association('tags', Association::MANY_TO_MANY, 'tag', 'id', 'id', null, 'landing_page_tag', 'tagId', 'landingPageId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
            ...
            (new Association('salesChannels', Association::MANY_TO_MANY, 'sales_channel', 'id', 'id', null, 'landing_page_sales_channel', 'salesChannelId', 'landingPageId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
