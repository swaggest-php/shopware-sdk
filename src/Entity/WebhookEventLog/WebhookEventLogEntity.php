...
final class WebhookEventLogEntity extends Entity
{
    use EntityIdTrait;
    ...
    public function getSerializedWebhookMessage(): string
    {
        return $this->serializedWebhookMessage;
    }

    public function setSerializedWebhookMessage(string $serializedWebhookMessage): void
    {
