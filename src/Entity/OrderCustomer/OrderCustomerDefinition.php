...
final class OrderCustomerDefinition extends AbstractEntityDefinition
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new AssociationField('order', AssociationField::ONE_TO_ONE, 'order', 'orderId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new AssociationField('customer', AssociationField::MANY_TO_ONE, 'customer', 'customerId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new SearchRanking(0.500000)),
