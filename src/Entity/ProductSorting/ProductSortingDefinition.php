...
final class ProductSortingDefinition extends AbstractEntityDefinition
{
    ...
    protected function defineFields(): array
    {
        return [
            ...
            (new AssociationField('translations', AssociationField::ONE_TO_MANY, 'product_sorting_translation', 'id', 'productSortingId', 'productSortingId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Inherited(), new Required()),
