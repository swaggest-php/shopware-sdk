...
final class NumberRangeTypeDefinition extends AbstractEntityDefinition
{
    ...
    protected function defineFields(): array
    {
        return [
            ...
            (new AssociationField('numberRanges', AssociationField::ONE_TO_MANY, 'number_range', 'id', 'typeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete()),
            (new AssociationField('numberRangeSalesChannels', AssociationField::ONE_TO_MANY, 'number_range_sales_channel', 'id', 'numberRangeTypeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
            (new AssociationField('translations', AssociationField::ONE_TO_MANY, 'number_range_type_translation', 'id', 'numberRangeTypeId', 'numberRangeTypeId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
