...
final class ThemeDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('translations', Association::ONE_TO_MANY, 'theme_translation', 'id', 'themeId', 'themeId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
            (new Association('salesChannels', Association::MANY_TO_MANY, 'sales_channel', 'id', 'id', null, 'theme_sales_channel', 'salesChannelId', 'themeId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('media', Association::MANY_TO_MANY, 'media', 'id', 'id', null, 'theme_media', 'mediaId', 'themeId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API])),
            (new Association('previewMedia', Association::MANY_TO_ONE, 'media', 'previewMediaId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('childThemes', Association::ONE_TO_MANY, 'theme', 'id', 'parentThemeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
