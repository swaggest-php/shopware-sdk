...
final class ProductExportDefinition extends AbstractEntityDefinition
{
    ...
    protected function defineFields(): array
    {
        return [
            ...
            (new AssociationField('storefrontSalesChannel', AssociationField::MANY_TO_ONE, 'sales_channel', 'storefrontSalesChannelId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            ...
            (new AssociationField('salesChannelDomain', AssociationField::MANY_TO_ONE, 'sales_channel_domain', 'salesChannelDomainId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
