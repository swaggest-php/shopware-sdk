...
final class CustomerDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('group', Association::MANY_TO_ONE, 'customer_group', 'groupId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API])),
            (new Association('defaultPaymentMethod', Association::MANY_TO_ONE, 'payment_method', 'defaultPaymentMethodId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API]), new SearchRanking(0.250000)),
            ...
            (new Association('lastPaymentMethod', Association::MANY_TO_ONE, 'payment_method', 'lastPaymentMethodId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API])),
            (new Association('defaultBillingAddress', Association::MANY_TO_ONE, 'customer_address', 'defaultBillingAddressId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API]), new SearchRanking(0.250000)),
            (new Association('defaultShippingAddress', Association::MANY_TO_ONE, 'customer_address', 'defaultShippingAddressId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API]), new SearchRanking(0.250000)),
            ...
            (new Association('addresses', Association::ONE_TO_MANY, 'customer_address', 'id', 'customerId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API]), new CascadeDelete()),
            (new Association('orderCustomers', Association::ONE_TO_MANY, 'order_customer', 'id', 'customerId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new SetNullOnDelete()),
            (new Association('tags', Association::MANY_TO_MANY, 'tag', 'id', 'id', null, 'customer_tag', 'tagId', 'customerId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new SearchRanking(0.250000)),
            (new Association('promotions', Association::MANY_TO_MANY, 'promotion', 'id', 'id', null, 'promotion_persona_customer', 'promotionId', 'customerId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('productReviews', Association::ONE_TO_MANY, 'product_review', 'id', 'customerId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('recoveryCustomer', Association::ONE_TO_ONE, 'customer_recovery', 'id', 'customerId', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            ...
            (new Association('requestedGroup', Association::MANY_TO_ONE, 'customer_group', 'requestedGroupId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Field('boundSalesChannelId', 'uuid'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('boundSalesChannel', Association::MANY_TO_ONE, 'sales_channel', 'boundSalesChannelId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('wishlists', Association::ONE_TO_MANY, 'customer_wishlist', 'id', 'customerId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
