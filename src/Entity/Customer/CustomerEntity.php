...
use Swaggest\ShopwareSdk\Entity\CustomerAddress\CustomerAddressEntity;
...
final class CustomerEntity extends Entity
{
    ...
    protected ?string $lastPaymentMethodId;
    ...
    protected ?\DateTimeInterface $doubleOptInConfirmDate;
    ...
    protected ?\DateTimeInterface $lastOrderDate;
    ...
    protected ?string $legacyEncoder;

    protected ?CustomerGroupEntity $group;
    ...
    protected ?PaymentMethodEntity $lastPaymentMethod;
    ...
    protected ?PromotionCollection $promotions;

    protected ?ProductReviewCollection $productReviews;

    protected ?CustomerRecoveryEntity $recoveryCustomer;
    ...
    protected ?CustomerGroupEntity $requestedGroup;

    protected ?string $boundSalesChannelId;

    protected ?SalesChannelEntity $boundSalesChannel;
