...
final class NumberRangeDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('type', Association::MANY_TO_ONE, 'number_range_type', 'typeId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('numberRangeSalesChannels', Association::ONE_TO_MANY, 'number_range_sales_channel', 'id', 'numberRangeId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
            (new Association('state', Association::ONE_TO_ONE, 'number_range_state', 'id', 'numberRangeId', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
            (new Association('translations', Association::ONE_TO_MANY, 'number_range_translation', 'id', 'numberRangeId', 'numberRangeId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
