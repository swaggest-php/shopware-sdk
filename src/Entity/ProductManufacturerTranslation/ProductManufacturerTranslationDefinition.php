...
final class ProductManufacturerTranslationDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('productManufacturer', Association::MANY_TO_ONE, 'product_manufacturer', 'productManufacturerId', 'id', null, null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
