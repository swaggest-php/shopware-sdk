...
final class ProductManufacturerDefinition extends AbstractEntityDefinition
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new AssociationField('products', AssociationField::ONE_TO_MANY, 'product', 'id', 'manufacturerId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new SetNullOnDelete(), new ReversedInherited('manufacturer')),
            (new AssociationField('translations', AssociationField::ONE_TO_MANY, 'product_manufacturer_translation', 'id', 'productManufacturerId', 'productManufacturerId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API, ProtectedFlag::SALES_CHANNEL_API]), new CascadeDelete(), new Required()),
