...
final class CurrencyDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('translations', Association::ONE_TO_MANY, 'currency_translation', 'id', 'currencyId', 'currencyId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
            (new Association('salesChannelDefaultAssignments', Association::ONE_TO_MANY, 'sales_channel', 'id', 'currencyId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete()),
            (new Association('orders', Association::ONE_TO_MANY, 'order', 'id', 'currencyId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete()),
            (new Association('salesChannels', Association::MANY_TO_MANY, 'sales_channel', 'id', 'id', null, 'sales_channel_currency', 'salesChannelId', 'currencyId'))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API])),
            (new Association('salesChannelDomains', Association::ONE_TO_MANY, 'sales_channel_domain', 'id', 'currencyId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete()),
            (new Association('promotionDiscountPrices', Association::ONE_TO_MANY, 'promotion_discount_prices', 'id', 'currencyId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
            (new Association('productExports', Association::ONE_TO_MANY, 'product_export', 'id', 'currencyId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete()),
            ...
            (new Association('countryRoundings', Association::ONE_TO_MANY, 'currency_country_rounding', 'id', 'currencyId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete()),
