...
final class UnitDefinition implements EntityDefinitionInterface
{
    ...
    public function defineFields(): array
    {
        return [
            ...
            (new Association('products', Association::ONE_TO_MANY, 'product', 'id', 'unitId', 'id', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new RestrictDelete(), new ReversedInherited('unit')),
            (new Association('translations', Association::ONE_TO_MANY, 'unit_translation', 'id', 'unitId', 'unitId', null, null, null))->addFlags(new ReadProtected([ProtectedFlag::ADMIN_API]), new CascadeDelete(), new Required()),
